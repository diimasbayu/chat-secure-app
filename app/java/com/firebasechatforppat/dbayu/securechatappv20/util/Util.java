...
public class Util {
    ...
    public static final String URL_STORAGE_REFERENCE = "gs://chatappv20.appspot.com";
    ...
    public static byte[] convertFileToByte(File file) {
        try {
            ...
            readFile.read(byteFile, 0, (int) file.length());
            readFile.close();
    ...
    public static void printFileToDisc(String path, byte[] byteFile) {
        try {
